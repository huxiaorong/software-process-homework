...
public class Movie {
    ...
    public Movie(int movieId, String name, String enName, Date releaseYear, String img, String country, int scene, String description, Date uploadYear, String video, String type) {
        this.movieId = movieId;
        this.name = name;
        this.enName = enName;
        this.releaseYear = releaseYear;
